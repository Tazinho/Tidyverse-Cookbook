...
* `packrat::off()`, to temporarily step out of "packrat mode", which means, that you will now use your global user library instead of the packrat project library.
* `packrat::on()`, to go back into "packrat mode".
