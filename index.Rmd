...
The basic idea of this book is to provide a documentation of the tidyverse written in a solution driven cookbook style. Note that you can search this book by clicking the second button on the left on top of each page.
...
A nice gain of this collaboration might be the possibility to learn R via fleshcards copied from this book into systems like [Anki](https://apps.ankiweb.net/) and become more fluent in the future.
