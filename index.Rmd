...
* I didn't use `drop = FALSE`, since I think it should be well known and I prefer to have a one-liner solution. 
* I also used `[` instead of `$`, because the first doesn't use partial matching.
...
* For tasks about modification of atomics the solution might also be written within `mutate`. 
